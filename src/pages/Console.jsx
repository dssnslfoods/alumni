  ...
  return (
    <div className="panel">
      ...
      <p className="panel-note">
        ...
        <br />
        ระบบอ่าน<strong>ปีที่เข้าศึกษา</strong>จากชื่อไฟล์ (เช่น 19-2500.xlsx = พ.ศ. 2500) หรือจากรหัสนิสิต/คอลัมน์ในไฟล์
        <br />
      ...
      <p className="panel-note">
        ใช้ทดลองนำเข้าเพื่อดูว่าระบบทำงานอย่างไร — รุ่น 82 มีเลขประจำตัวนิสิต, รุ่น 15 ไม่มีรหัสนิสิต (ปีที่เข้าศึกษาจะใช้จากชื่อไฟล์)
