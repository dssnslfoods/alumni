...
function ImportExport({ canReset }) {
  ...
  return (
    <div className="panel">
      ...
      <div className="button-row">
        <button className="ghost" onClick={() => download("/api/admin/import/demo/54-2535", "54-2535.xlsx")}>
          <Download /> รุ่น 54 (148 รายการ, มีรหัสนิสิต)
        </button>
      ...
      <p className="panel-note">
        ใช้ทดลองนำเข้าเพื่อดูว่าระบบทำงานอย่างไร — รุ่น 54 มีเลขประจำตัวนิสิต, รุ่น 15 ไม่มีรหัสนิสิต
