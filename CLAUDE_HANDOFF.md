...
| `scripts/smoke-test.mjs` | ทดสอบ end-to-end 38 รายการ |
...
1. กด **ดาวน์โหลดไฟล์ตัวอย่าง** เพื่อดูรูปแบบคอลัมน์ที่ถูกต้อง
...
| ข้อมูล | ชื่อคอลัมน์ที่ยอมรับ | บังคับ |
| --- | --- | --- |
| ชื่อ | `ชื่อ`, `ชื่อจริง`, `ชื่อสมัยเรียน`, `firstname`, `first name`, `name` | ✅ |
| นามสกุล | `นามสกุล`, `สกุล`, `lastname`, `last name`, `surname` | ✅ |
| รุ่น | `รุ่น`, `รุ่นที่`, `batch`, `class`, `year` | ✅ |
| เลขท้ายบัตร 5 หลัก | `เลขท้ายบัตรประชาชน 5 หลัก`, `เลขท้ายบัตรประชาชน`, `id card last 5` | ✅ |
| รหัสนิสิต | `รหัสนิสิต`, `student id`, `studentid` | แนะนำอย่างยิ่ง |
| คำนำหน้า | `คำนำหน้า`, `title`, `prefix` | — |

พฤติกรรมสำคัญ: **การนำเข้าซ้ำจะไม่ทับข้อมูลที่นิสิตเก่ากรอกไว้แล้ว**
เขียนทับเฉพาะคอลัมน์ที่มาจากไฟล์ Excel เท่านั้น (ชื่อสมัยเรียน, รุ่น, รหัสนิสิต, เลขบัตร)
...
ครอบคลุม 38 รายการ: การเข้าสู่ระบบ, การบังคับเปลี่ยนรหัสผ่าน, การเพิกถอน token,
การป้องกัน privilege escalation, ขอบเขตรุ่นของ `staff`, การนำเข้า Excel (dry run + จริง + ซ้ำ),
การค้นหา, การยืนยันตัวตน, การอัปโหลดรูปแบบ multipart, การส่งออก และ audit log
